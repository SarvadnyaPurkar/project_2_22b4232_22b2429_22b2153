...
def run_inference(test_csv, image_dir, output_file="submission.csv"):
    ...
    for _, row in df.iterrows():
        ...
        try:
            ...
            # prompt = "Solve this MCQ. Output only the correct option number (1-4). If unsure, output 5."
...
# if __name__ == "__main__":
#     # test_image = "images/image_5.png"   # change if needed
#     # run_single_image(test_image)
#     run_inference("test.csv", "images")
